...
if(NOT TBB_FOUND)
  ...
  find_library(TBB_LIBRARY_DEBUG
    NAMES tbb_debug
    HINTS ${TBB_ROOT} 
	PATH_SUFFIXES lib lib/x86_64-linux-gnu lib/intel64/gcc4.4 lib/intel64/gcc4.8 lib/intel64/cc4.1.0_libc2.4_kernel2.6.16.21
    ${_TBB_SEARCH_OPTS}
    )
  ...
  find_library(TBB_MAIN_LIBRARY_DEBUG
    NAMES tbb_main
    HINTS ${TBB_ROOT} 
		PATH_SUFFIXES lib/Debug lib lib/intel64/gcc4.4 lib/intel64/gcc4.8
    ${_TBB_SEARCH_OPTS}
    )
  ...
  if(NOT TBB_LIBRARY_RELEASE)
    find_path(TBB_LIB_DIR libtbb.so
              HINTS ${TBB_ROOT} 
              PATH_SUFFIXES lib lib/intel64/gcc4.4 lib/intel64/gcc4.8 lib/x86_64-linux-gnu
              ${_TBB_SEARCH_OPTS}
              )
    if(TBB_LIB_DIR)
